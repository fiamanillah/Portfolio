...
_Compiled at build time into static HTML/JS._
...
_Frontend client assets inlined at build time; server runs in standalone Node mode._
...
_Loaded and validated dynamically at server runtime using `@workspace/env` Zod schemas._
...
| `GOOGLE_REDIRECT_URI`              | Runtime | URL     | `http://localhost:3040/booking/v1/google/callback`                               | `https://api-fi.amanillah.com/booking/v1/google/callback`                | Authorized Google OAuth Redirect URI (Calendar)        |
| `GOOGLE_AUTH_CALLBACK_URL`         | Runtime | URL     | `http://localhost:3040/auth/v1/google/callback`                                  | `https://api-fi.amanillah.com/auth/v1/google/callback`                   | Authorized Google OAuth Callback URI (User Auth)       |

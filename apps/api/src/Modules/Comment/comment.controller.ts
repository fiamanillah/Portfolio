...
export class CommentController extends BaseController {
   ...
   */
  public async getPublicComments(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const slug = this.getParam(req.params.slug);
      const query = (req.validatedQuery || req.query) as ListPublicCommentsQueryDTO;
      const currentUserId = req.user?.id;

      const result = await this.commentService.getPublicComments(slug, query, currentUserId);
      this.sendResponse(req, res, "Comments retrieved successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async toggleReaction(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  public async reportComment(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const commentId = this.getParam(req.params.id);
      const body = (req.validatedBody || req.body) as ReportCommentDTO;
      const user = req.user;

      const result = await this.commentService.reportComment(commentId, body, user);
   ...
   */
  public async deleteOwnComment(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const commentId = this.getParam(req.params.id);
      const userId = req.user!.id;

      const result = await this.commentService.deleteOwnComment(commentId, userId);
      this.sendResponse(req, res, "Comment deleted successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
  ...
  public async getStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, "Moderation stats retrieved", HTTPStatusCode.OK, stats);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async getAdminComments(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const query = (req.validatedQuery || req.query) as ListAdminCommentsQueryDTO;
   ...
   */
  public async getAdminCommentById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = this.getParam(req.params.id);
      const comment = await this.commentService.getAdminCommentById(id);
      this.sendResponse(req, res, "Comment details retrieved", HTTPStatusCode.OK, comment);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async updateCommentStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = this.getParam(req.params.id);
      ...
      this.sendResponse(req, res, "Comment status updated successfully", HTTPStatusCode.OK, updated);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async deleteCommentAdmin(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = this.getParam(req.params.id);
      const result = await this.commentService.deleteCommentAdmin(id);
      this.sendResponse(req, res, "Comment removed permanently", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
  ...
  public async bulkUpdateStatus(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, `Updated ${result.count} comments`, HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
  ...
  public async bulkDelete(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, `Deleted ${result.count} comments`, HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async getAdminReports(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const query = (req.validatedQuery || req.query) as ListAdminReportsQueryDTO;
   ...
   */
  public async resolveReport(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = this.getParam(req.params.id);
      ...
      this.sendResponse(req, res, "Report resolution applied successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
  ...
  public async deleteReport(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, "Report deleted successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }

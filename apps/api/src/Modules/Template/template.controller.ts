...
export class TemplateController extends BaseController {
  ...
  public async createTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendCreatedResponse(req, res, result, "Email template created successfully");
    } catch (error) {
      next(error);
    }
  }
  ...
  public async getAllTemplates(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const result = await this.templateService.getAllTemplates(query as ListTemplatesQueryDTO);
   ...
   */
  public async getRemoteTemplates(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const result = await this.templateService.getRemotePlunkTemplates(req.query);
      this.sendResponse(req, res, "Remote Plunk templates retrieved successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async getTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, "Email template retrieved successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async duplicateTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const id = Array.isArray(req.params.id) ? req.params.id[0] : req.params.id;
      const result = await this.templateService.duplicateTemplate(id);
      this.sendCreatedResponse(req, res, result, "Email template duplicated successfully");
    } catch (error) {
      next(error);
    }
  }
   ...
   */
  public async syncAllTemplates(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const result = await this.templateService.syncAllToPlunk();
      this.sendResponse(req, res, "Template synchronization with Plunk completed", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }
  ...
  public async previewTemplate(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      this.sendResponse(req, res, "Template preview rendered successfully", HTTPStatusCode.OK, result);
    } catch (error) {
      next(error);
    }
  }

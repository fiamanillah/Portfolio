...
export class BlogModule extends BaseModule {
  ...
  protected async setupRoutes(): Promise<void> {
    ...
    this.router.get(
      "/public/featured",
      controller.getFeaturedPosts.bind(controller)
    )

    // GET /blogs/v1/public/categories - Categories with published counts
    this.router.get(
      "/public/categories",
      controller.getPublicCategories.bind(controller)
    )
    ...
    this.router.get(
      "/public/rss-feed",
      controller.getRssFeedData.bind(controller)
    )

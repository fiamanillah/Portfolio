...
export type CreateBlogCategoryDTO = import("@workspace/shared").CreateBlogCategoryDTO;
export type UpdateBlogCategoryDTO = import("@workspace/shared").UpdateBlogCategoryDTO;
...
export type ListBlogPostsQueryDTO = import("@workspace/shared").ListBlogPostsQueryDTO;

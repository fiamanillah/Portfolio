...
export class BlogController extends BaseController {
  ...
  public async bulkUpdateStatus(
    ...
    try {
      ...
      this.sendResponse(
        req,
        res,
        `Successfully updated ${result.count} blog posts to status '${status}'`,
        HTTPStatusCode.OK,
        result
      )
    } catch (error) {
  ...
  public async bulkDelete(
    ...
    try {
      ...
      this.sendResponse(
        req,
        res,
        `Successfully deleted ${result.count} blog posts`,
        HTTPStatusCode.OK,
        result
      )
    } catch (error) {
   ...
   */
  public async generateSeoPreview(
    req: Request,
    res: Response,
    next: NextFunction
  ): Promise<void> {
    try {
      ...
      this.sendResponse(
        req,
        res,
        "SEO preview & diagnostic analysis generated successfully",
        HTTPStatusCode.OK,
        analysis
      )
    } catch (error) {
  ...
  public async getPublicPostBySlug(
    ...
    try {
      ...
      const result = await this.blogService.getPublicPostBySlug(
        slug,
        incrementView
      )
      this.sendResponse(
  ...
  public async getPublicTags(
    ...
    try {
      ...
      this.sendResponse(
        req,
        res,
        "Public tags retrieved successfully",
        HTTPStatusCode.OK,
        tags
      )
    } catch (error) {
  ...
  public async getRssFeedData(
    ...
    try {
      ...
      this.sendResponse(
        req,
        res,
        "RSS feed data retrieved successfully",
        HTTPStatusCode.OK,
        feed
      )
    } catch (error) {
  ...
  public async reactToPost(
    ...
    try {
      ...
      const result = await this.blogService.reactToPost(
        slug,
        reactionType,
        req.user?.id,
        ipAddress

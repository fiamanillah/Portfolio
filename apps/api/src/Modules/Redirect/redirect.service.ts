...
import { prisma, Prisma, RedirectEntityType, type Redirect } from "@workspace/db"
...
export class RedirectService {
  ...
  public async resolve(rawPath: string): Promise<ResolvedRedirectDTO> {
    ...
    try {
      ...
      this.logger.warn(`Redis cache read failed for path '${normalizedPath}':`, {
  ...
  public async getAllAdmin(query: QueryRedirectsDTO): Promise<{
    ...
    const orderBy: Prisma.RedirectOrderByWithRelationInput = {
      [sortBy]: sortOrder,
    }

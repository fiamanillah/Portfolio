...
export type AdminSubscriberQueryDTO = import("@workspace/shared").AdminSubscriberQuery;
export type AdminCreateSubscriberDTO = import("@workspace/shared").AdminCreateSubscriberPayload;
export type AdminBulkUpdateStatusDTO = import("@workspace/shared").AdminBulkUpdateStatusPayload;
export type AdminBulkDeleteDTO = import("@workspace/shared").AdminBulkDeletePayload;

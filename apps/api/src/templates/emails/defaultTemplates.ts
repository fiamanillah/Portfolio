...
export const SYSTEM_TEMPLATES: SystemTemplateDefinition[] = [
  {
    ...
    description: "Confirmation email sent automatically to users who submit the contact form with a summary copy of their message.",
    ...
    sampleData: {
      ...
      message: "Hi Fi, I came across your engineering blog and was impressed by your microservices write-up. Would love to discuss a potential advisory role.",
      subscribed: true,
      unsubscribeUrl: "https://fi.amanillah.com/unsubscribe?token=sample_token_123",
  ...
  },
  {
    ...
    description: "Internal alert sent to portfolio administrator whenever a visitor submits a contact form message.",
    subject: "[Portfolio Contact] {{ subject | default: 'New Submission' }} — from {{ name }}",
  ...
  },
  {
    ...
    description: "Welcome email sent to newly subscribed visitors with unsubscribe link and engineering blog highlights.",
    ...
    sampleData: {
      ...
      unsubscribeUrl: "https://fi.amanillah.com/unsubscribe?token=sample_token_456",
      manageUrl: "https://fi.amanillah.com/manage",
    },
  },
  {
    ...
    description: "Campaign template for announcing new engineering articles, project launches, and system design case studies.",
    subject: "{{ title | default: 'New Post: Scaling Real-Time WebSockets' }} — Fi Amanillah",
    ...
    sampleData: {
      ...
      previewText: "Exploring event-driven architecture, CQRS, and zero-downtime database migrations.",
      tag: "Architecture",
      articleTitle: "Event Sourcing and CQRS at Scale in Node.js & Go",
      articleExcerpt: "How we decoupled message brokers and achieved sub-millisecond query latencies across geographically distributed clusters.",

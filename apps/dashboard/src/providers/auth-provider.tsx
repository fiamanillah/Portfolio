    ...
    return (
      <div className="flex min-h-screen w-full flex-col items-center justify-center bg-background/95 p-6 backdrop-blur-xs">
        <div className="flex flex-col items-center gap-4 text-center max-w-sm">
          <div className="relative flex size-14 items-center justify-center rounded-2xl bg-primary/10 text-primary shadow-inner border border-primary/20">
            <Loader2 className="size-7 animate-spin text-primary" />
            <div className="absolute -inset-1 rounded-2xl bg-primary/20 blur-md -z-10 animate-pulse" />
          </div>
          <div className="space-y-1">
            <h3 className="font-semibold text-lg tracking-tight">Authenticating Admin</h3>

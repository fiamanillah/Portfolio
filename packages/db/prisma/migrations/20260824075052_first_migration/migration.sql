...
-- CreateEnum
CREATE TYPE "CaseStudyType" AS ENUM ('CASE_STUDY', 'PROJECT');
...
-- CreateEnum
CREATE TYPE "RedirectEntityType" AS ENUM ('BLOG_POST', 'CASE_STUDY', 'BLOG_CATEGORY', 'STATIC_PAGE', 'CUSTOM');
...
CREATE TABLE "CaseStudy" (
    ...
    "projectType" "CaseStudyType" NOT NULL DEFAULT 'CASE_STUDY',
...
CREATE TABLE "Redirect" (
    ...
    "entityType" "RedirectEntityType" NOT NULL DEFAULT 'CUSTOM',
    "entityId" TEXT,
...
-- CreateIndex
CREATE INDEX "CaseStudy_projectType_status_idx" ON "CaseStudy"("projectType", "status");
...
-- CreateIndex
CREATE INDEX "Redirect_sourcePath_isActive_idx" ON "Redirect"("sourcePath", "isActive");

-- CreateIndex
CREATE INDEX "Redirect_entityType_entityId_idx" ON "Redirect"("entityType", "entityId");
